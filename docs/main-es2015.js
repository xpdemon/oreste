...
/* harmony import */ var ngx_order_pipe__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ngx-order-pipe */ "./node_modules/ngx-order-pipe/fesm2015/ngx-order-pipe.js");
...
let ArmesDetailComponent = class ArmesDetailComponent {
    constructor() {
...
let ArmesComponent = class ArmesComponent {
    constructor(es) {
        this.es = es;
        this.selectedArme = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
...
let ArmuresDetailsComponent = class ArmuresDetailsComponent {
    constructor() {
...
let ArmuresComponent = class ArmuresComponent {
    constructor(es) {
        this.es = es;
        this.selectedArmure = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
...
ArmuresComponent.ctorParameters = () => [
    { type: src_app_shared_elastic_service__WEBPACK_IMPORTED_MODULE_2__["ElasticService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
...
let PouvoirDetailComponent = class PouvoirDetailComponent {
    constructor() {
...
let PouvoirComponent = class PouvoirComponent {
    constructor(es) {
        this.es = es;
        this.selectedPouvoir = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ...
    pouvoirToSend(pouvoir) {
        this.pouvoir = pouvoir;
        this.selectedPouvoir.emit(this.pouvoir);
    }
};
PouvoirComponent.ctorParameters = () => [
    { type: src_app_shared_elastic_service__WEBPACK_IMPORTED_MODULE_2__["ElasticService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
...
let CreationPersoOresteComponent = class CreationPersoOresteComponent {
    constructor(es) {
        this.es = es;
        this.pouvoirList = [];
    ...
    getSelectedArmure(armure) {
        this.armure = armure;
    }
    getSelectedPouvoir(pouvoir) {
        this.pouvoir = pouvoir;
    ...
    suppPouvoir(pouvoir) {
        const index = this.pouvoirList.indexOf(pouvoir);
        this.pouvoirList.splice(index, 1);
    }
};
CreationPersoOresteComponent.ctorParameters = () => [
...
let PersonnageOresteDetailComponent = class PersonnageOresteDetailComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PersonnageOresteComponent = class PersonnageOresteComponent {
    constructor() { }
    ngOnInit() {
    }
};
